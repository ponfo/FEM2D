program precomp
  ...
  open(function, file = trim(path)//'/FEM2D/Source/Source/functionOnPoints.f90')
  ...
  open(function, file = trim(path)//'/FEM2D/Source/Source/functionOnLines.f90')
  ...
  open(function, file = trim(path)//'/FEM2D/Source/Source/functionOnSurfaces.f90')
