module ThBoundaryCondition1DMOD
  use tools
  use DebuggerMOD
  ...
  implicit none
  private
  public :: ThBoundaryCondition1DTYPE, thermalBoundaryCondition1D
  type ThBoundaryCondition1DTYPE
   ...
   contains
     ...
     procedure :: apply
  end type ThBoundaryCondition1DTYPE
...
contains
  ...
  type(ThBoundaryCondition1DTYPE) function constructor(nDirichlet, nNormalFlux, nConvection)
    implicit none
  ...
  subroutine init(this, nDirichlet, nNormalFlux, nConvection)
    implicit none
    class(ThBoundaryCondition1DTYPE), intent(inout) :: this
    integer(ikind), intent(in) :: nDirichlet
    integer(ikind), intent(in) :: nNormalFlux
    integer(ikind), intent(in) :: nConvection
...
end module ThBoundaryCondition1DMOD
