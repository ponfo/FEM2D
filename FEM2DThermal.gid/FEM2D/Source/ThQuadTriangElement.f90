module ThQuadTriangElementMOD
  ...
  implicit none
  private
  public :: ThQuadTriangElementTYPE, thermalQuadTriangElement
  type, extends(TriangElementTYPE) :: ThQuadTriangElementTYPE
     private
   contains
     procedure, public :: init
     procedure, public :: shapeFunc
     procedure, public :: dShapeFunc
  end type ThQuadTriangElementTYPE
...
end module ThQuadTriangElementMOD
