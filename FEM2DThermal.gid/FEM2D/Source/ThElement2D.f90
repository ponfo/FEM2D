module ThElement2DMOD
  use tools
  use Element2DMOD
  use IntegratorPtrMOD
  implicit none
  private
  public :: ThElement2DTYPE
  type, abstract, extends(Element2DTYPE) :: ThElement2DTYPE
   contains
     procedure, public :: getStiffness
  end type ThElement2DTYPE

contains

  function getStiffness(this)
    implicit none
    class(ThElement2DTYPE), intent(inout) :: this
