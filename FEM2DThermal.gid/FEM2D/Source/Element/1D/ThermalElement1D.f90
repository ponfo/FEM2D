module ThermalElement1DMOD
  use tools
  use Element1DMOD
  use IntegratorPtrMOD
  implicit none
  private
  public :: ThermalElement1DTYPE
  type, abstract, extends(Element1DTYPE) :: ThermalElement1DTYPE
   contains
     procedure, public :: getStiffness
  end type ThermalElement1DTYPE

contains

  function getStiffness(this)
    implicit none
    class(ThermalElement1DTYPE), intent(inout) :: this
...
end module ThermalElement1DMOD
