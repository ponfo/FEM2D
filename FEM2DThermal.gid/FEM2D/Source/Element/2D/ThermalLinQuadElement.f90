module ThermalLinQuadElementMOD
  use tools
  use PointMOD
  use PointPtrMOD
  use MaterialPtrMOD
  ...
  implicit none
  private
  public :: ThermalLinQuadElementTYPE, thermalLinearQuadElement
  type, extends(QuadElementTYPE) :: ThermalLinQuadElementTYPE
     private
   contains
     procedure, public :: init
     procedure, public :: shapeFunc
     procedure, public :: dShapeFunc
  end type ThermalLinQuadElementTYPE
...
contains
  ...
  type(ThermalLinQuadElementTYPE) function constructor(id, material, point, integrator)
    implicit none
  ...
  subroutine init(this, id, material, point, integrator)
    implicit none
    class(ThermalLinQuadElementTYPE), intent(inout) :: this
    integer(ikind), intent(in) :: id
    type(MaterialPtrTYPE), intent(in) :: material
    type(PointPtrTYPE), dimension(:), intent(in) :: point
    type(IntegratorTYPE), intent(in) :: integrator
...
end module ThermalLinQuadElementMOD
