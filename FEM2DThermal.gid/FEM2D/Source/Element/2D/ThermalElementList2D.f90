module ThermalElementList2DMOD
  use tools
  use DebuggerMOD

  use Element2DMOD
  use Element2DPtrMOD
  use ThermalLinTriangElementMOD
  use ThermalLinQuadElementMOD
  use ThermalQuadTriangElementMOD
  use ThermalQuadQuadElementMOD
  ...
  implicit none
  private
  public :: ThermalElementList2DTYPE, thermalElementList2D
  type :: ThermalElementList2DTYPE
     private
  ...
  end type ThermalElementList2DTYPE
  ...
  type(ThermalLinTriangElementTYPE) , save, dimension(:), allocatable, target :: linTriangElem
  type(ThermalLinQuadElementTYPE)   , save, dimension(:), allocatable, target :: linQuadElem
  type(ThermalQuadTriangElementTYPE), save, dimension(:), allocatable, target :: quadTriangElem
  type(ThermalQuadQuadElementTYPE)  , save, dimension(:), allocatable, target :: quadQuadElem
  
contains

  type(ThermalElementList2DTYPE) function constructor(isQuadratic, nTriangElem, nQuadElem, nGauss)
    implicit none
  ...
  subroutine init(this, isQuadratic, nTriangElem, nQuadElem, nGauss)
    implicit none
    class(ThermalElementList2DTYPE), intent(inout) :: this
    integer(ikind), intent(in) :: isQuadratic
    integer(ikind), intent(in) :: nTriangElem
    integer(ikind), intent(in) :: nQuadElem
    integer(ikind), intent(in) :: nGauss
...
end module ThermalElementList2DMOD
